...
import { CircleImgBox, ImgBox, ThumbnailImgBox } from '@styles/commonStyle'
...
import { 
  BalanceOption,CommentBox,ContentBox, ContentTitle, DebateRulesBox, DetailDevateContainor,
  HeaderButtonBox,HeaderCategoryLine,HeaderInfoBox, IndexContainor, OpinionListBox, PostContentBox, 
  PostCurrentSituationBox,PostHeaderBox, RelatedPostsBox, SelectBox 
  ...
  return (
    <IndexContainor>
      <DetailDevateContainor>
        ...
        <PostContentBox>
          <ThumbnailImgBox height='200'>
            <img src={postData.imgUrl ? postData.imgUrl : '' } alt="thumbnail-img" />
          </ThumbnailImgBox>
        ...
        <SelectBox>
          <span>선택지 :</span>
          <select onChange={onChangeSelection} value={selection}>
...
DetailDebatePage.getLayout = function getLayout(page: ReactElement) {
