...
import { getDebatePosts } from '@store/slices/debatePosts/debatePosts'
...
const DebateForumPage = () => {
  ...
  useEffect(() => {
    ...
    fetchData()
  }, [debateMode, debateCategory, searchText, selectOption])
        ...
        <DebateForumBox>
          ...
          <DetailControllBox>
            <BasicSearchBox>
              ...
              <input placeholder='검색' value={searchText} onChange={onChangeSearchText}></input>
            </BasicSearchBox>
