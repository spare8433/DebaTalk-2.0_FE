...
export default (inputValue : string, type: InputType, chk_password?: string):[string, (e: React.ChangeEvent<HTMLInputElement>) => void, string, boolean] => {
  ...
  // regex check
  else if (!REGEX_RULE[type].test(value)){
